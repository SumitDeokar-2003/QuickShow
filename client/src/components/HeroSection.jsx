...
const HeroSection = () => {
  ...
  return (
    ...
    bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
      ...
      <button onClick={() => navigate("/movies")} className='flex gap-1 items-center bg-red-500 hover:bg-primary-dull rounded-full cursor-pointer text-sm font-semibold px-6 py-3'>Explore Movies<ArrowRight className='w-5 h-5'/></button>
    </div>
  )
}
