...
const Dashboard = () => {
  ...
  const dashboardCards = [
    ...
    { title: "Total Users", value: dashboardData.totalBooking || "0", icon: UserIcon},
  ]
  ...
  return !loading ? (
    <>
      ...
      <p className="text-lg font-medium mt-10">Active Movies</p>
      <div className="relative flex flex-wrap gap-6 mt-4 max-w-5xl">
        <BlurCircle top="100px" left="-10%"/>
        {dashboardData.activeShows.map((show) => (
          <div key={show._id} className="w-55 rounded-lg overflow-hidden border
          border-primary/20 h-full pb-3 bg-primary/10 hover:-translate-y-1
