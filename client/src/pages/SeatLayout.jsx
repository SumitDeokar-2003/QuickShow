...
const groupRows = [["A","B"], ["C","D"], ["E","F"], ["G","H"], ["I","J"]]
  ...
  return show ? (
    <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50">
      {/* Available Timings */}
      <div className='border border-primary/20 bg-primary/10 w-60 py-10 
      h-max md:sticky md:top-30 rounded-lg'>
        <p className='font-semibold text-lg px-6'>Available Timing</p>
      ...
      <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>
          ...
          <div className='flex flex-col items-center mt-10 text-xs text-gray-300'>
            ...
            className='flex items-center gap-1 mt-20 bg-primary 
            hover:bg-primary-dull text-sm px-10 py-3 rounded-full transition 
            cursor-pointer font-medium active:scale-95'>
              Proceed to Checkout 
